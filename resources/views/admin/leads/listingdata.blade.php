                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($leads as $lead)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="h-10 w-10 flex-shrink-0 rounded-full bg-blue-100 flex items-center justify-center">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ $lead->client_name ? $lead->client_name : 'N/A' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                            ...
                            ">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ ucfirst(str_replace('_', ' ', $lead->lead_source)) }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="{{ route('leaddelete', $lead->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
        ...
        function deleteLead(leadId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`/account_manager/leaddelete/${leadId}`, {
                            method: 'DELETE',
                            headers: {
