            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3 p-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pin_code" id="pin_code"
                                        ...
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('pin_code') border-red-500 @enderror"
                ...
                <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    <input type="number" name="budget" id="budget_amount"
                                        ...
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('budget') border-red-500 @enderror"
                                        placeholder="Amount">
                                </div>
                                <div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="lead_source" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div>
                                ...
                                <textarea name="message" id="message" rows="4"
                                    ...
                                    placeholder="Enter any additional notes or message">{{ old('message', $data->message ?? '') }}</textarea>
                                @error('message')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
