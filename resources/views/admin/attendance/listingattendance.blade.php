                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-emerald-600 mt-1">
                            {{ $attendances->where('status', 'present')->count() }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-amber-600 mt-1">
                            {{ $attendances->where('status', 'late')->count() }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600 mt-1">
                            {{ $attendances->where('status', 'absent')->count() }}</p>
                    </div>
        ...
        <form method="GET" action="{{ route('attendance.list') }}"
            ...
            <div class="flex flex-col lg:flex-row gap-4 justify-between items-end">
                <div class="flex-1 w-full">
                    ...
                    <select name="status"
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50">
                ...
                <div class="flex gap-3">
                    <button type="submit"
                        class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-all duration-200 shadow-sm flex items-center gap-2">
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                Lunch Out</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">End
                                Work</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                Total Hours</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-800">
                                                {{ $attendance->employee->name ?? 'N/A' }}</p>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <div class="flex gap-2">
                                        ...
                                        @endphp
                                        <a href="{{ $route }}"
                                            class="text-gray-400 hover:text-blue-600 transition" title="View Details">
