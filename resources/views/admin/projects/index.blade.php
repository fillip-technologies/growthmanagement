                            ...
                            <tr class="table-row hover:bg-orange-50/50 transition-all duration-200" data-status="{{ $p->status }}" data-priority="{{ $p->priority }}" data-name="{{ strtolower($p->name) }}" data-description="{{ strtolower($p->description) }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center justify-center gap-1.5">
                                        ...
                                        <form action="{{ route('project.delete', $p->id) }}" method="POST" class="delete-form inline" data-name="{{ $p->name }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                        ...
                                        <form action="{{ route('addtotask', $p->id) }}" method="POST" class="inline">
                                            @csrf
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center gap-4">
                                        ...
                                        <a href="{{ route('project.create') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all">
                                            <i class="fas fa-plus"></i>
                                            Create Project
                                        </a>
                                    </div>
