...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-gray-100 to-orange-50/30 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
            ...
            <form action="{{ route('updatdproduct',$project->id) }}" method="POST" class="animate-fade-up"
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="task_name"
                                            placeholder="e.g., E-Commerce Platform, Mobile App Development"
                                            value="{{ old('task_name', $project->task_name) }}"
                                            class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-orange-400 transition-all duration-200">
                                        <i
                                ...
                                <div>
                                    ...
                                    <textarea name="what_be_do" rows="5" placeholder="Describe the project scope, objectives, and key deliverables..."
                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-orange-400 transition-all duration-200 resize-none">{{ old('what_be_do', $project->what_be_do) }}</textarea>
                                    @error('what_be_do')
                                ...
                                <div>
                                    ...
                                    <div class="m-4 p-4">
                                        <iframe src="{{ asset($project->attechment) }}" frameborder="0"></iframe>
                                    </div>
                                    @error('attechment')
                                        <p class="text-red-500 text-xs mt-1 flex items-center gap-1"><i
                                                class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="start_date"
                                            value="{{ old('start_date', $project->start_date ? \Carbon\Carbon::parse($project->start_date)->format('Y-m-d\TH:i') : '') }}"
                                            class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-orange-400 transition-all duration-200">
                                        <i
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="datetime-local" name="end_date"
                                            value="{{ old('end_date', $project->end_date ? \Carbon\Carbon::parse($project->end_date)->format('Y-m-d\TH:i') : '') }}"
                                            class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-orange-400 transition-all duration-200">
                                        <i
